...
{
	[JsonRequired] public int Level { get; set; }

	[JsonRequired] public string ImagePath { get; set; }

	[JsonRequired] public BoundingRectangle ImageBounds { get; set; }

	[JsonRequired] public List<BoundingRectangularSolid> GameBounds { get; set; }
}
...
public class MapMarkerDef
{
	...
	[JsonRequired] public Vector3 Position { get; set; }
...
public class MapDef
{
	...
	[JsonRequired] public BoundingRectangle Bounds { get; set; }

	[JsonRequired] public Dictionary<string, MapLayerDef> Layers { get; set; } = new Dictionary<string, MapLayerDef>();
